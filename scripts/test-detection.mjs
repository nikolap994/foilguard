...
expect('g00gle.com → digit substitution reason',  g00gle.reasons.some(r => r.includes('digit')), true)
...
expect('paypal.evil.com → subdomain reason',                 paypalEvil.reasons.some(r => r.includes('subdomain') || r.includes('Subdomain')), true)
...
expect('Cyrillic paypal → reason mentions characters',
  cyrillic.reasons.some(r => r.includes('non-ASCII') || r.includes('visually')), true)
